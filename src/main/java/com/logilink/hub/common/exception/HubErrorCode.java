...
public enum HubErrorCode implements ErrorCode {
    ...
    HUB_NAME_DUPLICATE("HUB0002", "이미 사용 중인 허브 이름입니다.", HttpStatus.CONFLICT),
    HUB_ROUTE_NOT_FOUND("HUB0003", "해당 허브 이동 경로를 찾을 수 없습니다.", HttpStatus.NOT_FOUND),
    HUB_ROUTE_DUPLICATE("HUB0004", "이미 존재하는 허브 이동 경로입니다.", HttpStatus.CONFLICT);
